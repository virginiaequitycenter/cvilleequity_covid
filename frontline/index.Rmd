...
* While 57 percent of the overall workforce in the region do not have a college degree, this is more likely in all frontline industries except Health Care and Education. The differences are especially big in Grocery, Convenience, and Drug Stores (82 percent without a college degree), Trucking, Warehouse, and Postal Service (94 percent), Building Cleaning Services (91 percent), and Public Transit (93 percent).
...
* Ten percent of workers in our region lack health insurance. The proportions are notably higher among frontline workers in Building Cleaning Services (34 percent), and Grocery, Convenience, and Drug Stores, in Trucking, Warehouse, and Postal Service (15 percent), and in Child Care and Social Services (15 percent).
...
fl %>%  
  ...
  ggplot(demo_comparisons, aes(x = fct_rev(Job), y = percent, fill = Level)) + 
...
Community-based advoates from the Equity Center Local Steering Committee, working with UVA's President's Council on Community-Univeristy Partnershipsm, is developing a Fair Treatment Charter for Frontline Workers outlining acomprehensive set of policies and practices. (Link when available.)
