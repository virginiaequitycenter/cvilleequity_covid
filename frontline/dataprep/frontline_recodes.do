...
MODIFIED
File: frontline_recodes.do
Date: May 18, 2020
Desc: Variables recodes for 2014-2018 5-year ACS cville region
*/
...
notes powpuma10: Boundaries for 2012-2018 are based on 2010 Census definition
	...
	/* Industry  Occupation */
/*Industry Recode, consistent 3 digit*/
do frontline_ind3d.do

/*SOC Occupation Code*/
do frontline_socp.do

/*INDOCC Industory Occupation Code*/
do frontline_indocc.do
...
replace agegrp=3 if (35<=age & age<=54)
replace agegrp=4 if (55<=age & age<=64)
replace agegrp=5 if (65<=age & age~=.)
lab var age "Age group"
lab def agegrp 1 "16-24" 2 "25-34" 3 "35-54" 4 "55-64" 5 "65+"
...
save acs_1418_frontline, replace
